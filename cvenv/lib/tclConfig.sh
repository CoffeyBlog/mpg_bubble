...
# installed.
TCL_PREFIX='/Users/coffey/local-docs/data/mpg_bubble/cvenv'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Users/coffey/local-docs/data/mpg_bubble/cvenv'
...
TCL_EXTRA_CFLAGS='-march=core2 -mtune=haswell -mssse3 -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Users/coffey/local-docs/data/mpg_bubble/cvenv/include -fdebug-prefix-map=/opt/concourse/worker/volumes/live/10dd1500-e7e9-4eb8-4ab4-a7c774e03737/volume/tk_1592503177392/work=/usr/local/src/conda/tk-8.6.10 -fdebug-prefix-map=/Users/coffey/local-docs/data/mpg_bubble/cvenv=/usr/local/src/conda-prefix -pipe  -arch x86_64 -D_FORTIFY_SOURCE=2 -mmacosx-version-min=10.9 -isystem /Users/coffey/local-docs/data/mpg_bubble/cvenv/include '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Users/coffey/local-docs/data/mpg_bubble/cvenv/lib -L/Users/coffey/local-docs/data/mpg_bubble/cvenv/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Users/coffey/local-docs/data/mpg_bubble/cvenv/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Users/coffey/local-docs/data/mpg_bubble/cvenv/include'
...
TCL_PACKAGE_PATH='/Users/coffey/local-docs/data/mpg_bubble/cvenv/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Users/coffey/local-docs/data/mpg_bubble/cvenv/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Users/coffey/local-docs/data/mpg_bubble/cvenv/lib/libtclstub8.6.a'
